    ...
    <section class="content" id="content">
      <div class="presentation-server">
        <div class="text-block">
          <p class="slogan"><span>“</span>{{$slogan}}<span>”</span></p>
        </div>
      </div>
    </section>
        ...
        <div class="trailer-video-block">
          ...
          <div class="text-trailer">
            ...
            <div class="text-video-trailer">
				<p>
					La nouvelle version de Rushy arrive bientôt, et elle envoie du lourd !
					Découvre le nouveau spawn au thème spatial unique ainsi que nos modes de jeu inédits: Rush, RushTheFlag, RushBox, et même des SkyWars ainsi que le retour de la tant attendue PvPBox !
				</p>
				Trailer réalisé par Shormir.
            </div>
          </div>
        </div>
